        ...
        <div class="ub umar-t10">
           ...
           <div class="ub umar-t8">
               ...
               <div class="ub ub-ac umar-l40 uw-300">
                   ...
                   <label><input class="priceItem" type="checkbox" name="isUpUntaxedPrice" id="isUpUntaxedPrice" disabled="disabled"  <c:if test="${data.isUpUntaxedCostPrice == 1}"> checked="checked" </c:if> /><span>不含税成本价</span></label>
               </div>
           </div>
