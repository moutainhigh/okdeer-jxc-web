        ...
        <div class="ub umar-t10">
           ...
           <div class="ub umar-t8">
               ...
               <div class="ub ub-ac umar-l40 uw-300" id="ckboxPric">
                   ...
                   <label><input class="priceItem" type="checkbox" name="isUpCostPrice" id="isUpCostPrice" <c:if test="${data.isUpCostPrice == 1}"> checked="checked" </c:if>/><span>成本价</span></label>
                   <label><input class="priceItem" type="checkbox" name="isUpUntaxedCostPrice" id="isUpUntaxedCostPrice" <c:if test="${data.isUpUntaxedCostPrice == 1}"> checked="checked" </c:if>/><span>不含税成本价</span></label>
               </div>
           </div>
