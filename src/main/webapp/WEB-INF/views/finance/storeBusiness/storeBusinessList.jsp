...
<title>门店经营数据录入</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script
	src="${ctx}/static/js/views/finance/storeBusiness/storeBusinessList.js?V=${versionNo}1"></script>
<style>
...
<body class="ub uw uh ufs-14 uc-black">
	<div class="ub ub-ver ub-f1 umar-4 upad-4">
		<form id="queryForm" method="post">
			<div class="ub ub-ac">
				<div class="ubtns">
					<div class="ubtns-item" onclick="queryStoreBusiness()">查询</div>
					...
					<shiro:hasPermission name="JxcStoreBusiness:delete">
						<div class="ubtns-item" onclick="storeBusinessDelete()">删除</div>
					</shiro:hasPermission>
					<shiro:hasPermission name="JxcStoreBusiness:reset">
						<div class="ubtns-item" onclick="gFunRefresh()">重置</div>
					</shiro:hasPermission>
					<div class="ubtns-item" onclick="toClose()">关闭</div>
					
					<div id="updatePermission" class="none">
						<shiro:hasPermission name="JxcStoreBusiness:update">修改</shiro:hasPermission>
					</div>
				</div>
			...
			<div class="ub umar-t8">
				...
				<div class="ub ub-ac umar-r40">
					...
					<input class="uinp" id="createUserName" name="createUserName" type="text"
		...
		<div class="ub uw umar-t8 ub-f1">
			<table id="gridStoreBusinessList"></table>
		</div>
